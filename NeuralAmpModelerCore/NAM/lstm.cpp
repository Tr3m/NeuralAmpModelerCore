...
nam::lstm::LSTM<SampleType>::LSTM(const int num_layers, const int input_size, const int hidden_size, std::vector<float>& weights,
...
template <typename SampleType>
void nam::lstm::LSTM<SampleType>::process(SampleType* input, SampleType* output, const int num_frames)
{
...
template <typename SampleType>
float nam::lstm::LSTM<SampleType>::_process_sample(const float x)
{
...
template class nam::lstm::LSTM<float>;
template class nam::lstm::LSTM<double>;
...
nam::DSP<SampleType>::DSP(const SampleType expected_sample_rate)
: mExpectedSampleRate(expected_sample_rate)
{
}

template <typename SampleType>
void nam::DSP<SampleType>::prewarm()
{
  if (_prewarm_samples == 0)
    return;

  SampleType sample = 0;
  SampleType* sample_ptr = &sample;
...
template <typename SampleType>
void nam::DSP<SampleType>::process(SampleType* input, SampleType* output, const int num_frames)
{
...
template <typename SampleType>
SampleType nam::DSP<SampleType>::GetLoudness() const
{
  if (!HasLoudness())
  {
...
template <typename SampleType>
void nam::DSP<SampleType>::SetLoudness(const SampleType loudness)
{
  mLoudness = loudness;
  mHasLoudness = true;
}
...
template <typename SampleType>
void nam::DSP<SampleType>::finalize_(const int num_frames) {}

// Buffer =====================================================================

template <typename SampleType>
nam::Buffer<SampleType>::Buffer(const int receptive_field, const SampleType expected_sample_rate)
: nam::DSP<SampleType>(expected_sample_rate)
{
  this->_set_receptive_field(receptive_field);
}

template <typename SampleType>
void nam::Buffer<SampleType>::_set_receptive_field(const int new_receptive_field)
{
  this->_set_receptive_field(new_receptive_field, _INPUT_BUFFER_SAFETY_FACTOR * new_receptive_field);
};

template <typename SampleType>
void nam::Buffer<SampleType>::_set_receptive_field(const int new_receptive_field, const int input_buffer_size)
{
...
template <typename SampleType>
void nam::Buffer<SampleType>::_update_buffers_(SampleType* input, const int num_frames)
{
...
template <typename SampleType>
void nam::Buffer<SampleType>::_rewind_buffers_()
{
...
template <typename SampleType>
void nam::Buffer<SampleType>::_reset_input_buffer()
{
  this->_input_buffer_offset = this->_receptive_field;
}

template <typename SampleType>
void nam::Buffer<SampleType>::finalize_(const int num_frames)
{
  this->nam::DSP<SampleType>::finalize_(num_frames);
...
template <typename SampleType>
nam::Linear<SampleType>::Linear(const int receptive_field, const bool _bias, const std::vector<float>& weights,
                    const SampleType expected_sample_rate)
: nam::Buffer<SampleType>(receptive_field, expected_sample_rate)
{
...
template <typename SampleType>
void nam::Linear<SampleType>::process(SampleType* input, SampleType* output, const int num_frames)
{
  this->nam::Buffer<SampleType>::_update_buffers_(input, num_frames);
...
template class nam::DSP<float>;
template class nam::DSP<double>;

template class nam::Buffer<float>;
template class nam::Buffer<double>;

template class nam::Linear<float>;
template class nam::Linear<double>;
...
nam::wavenet::WaveNet<SampleType>::WaveNet(const std::vector<nam::wavenet::LayerArrayParams>& layer_array_params,
                               const float head_scale, const bool with_head, std::vector<float> weights,
                               const SampleType expected_sample_rate)
: DSP<SampleType>(expected_sample_rate)
, _num_frames(0)
, _head_scale(head_scale)
{
  ...
  this->_prewarm_samples = 1;
  for (size_t i = 0; i < this->_layer_arrays.size(); i++)
    this->_prewarm_samples += this->_layer_arrays[i].get_receptive_field();
}

template <typename SampleType>
void nam::wavenet::WaveNet<SampleType>::finalize_(const int num_frames)
{
...
template <typename SampleType>
void nam::wavenet::WaveNet<SampleType>::set_weights_(std::vector<float>& weights)
{
...
template <typename SampleType>
void nam::wavenet::WaveNet<SampleType>::_advance_buffers_(const int num_frames)
{
  for (size_t i = 0; i < this->_layer_arrays.size(); i++)
...
template <typename SampleType>
void nam::wavenet::WaveNet<SampleType>::_prepare_for_frames_(const long num_frames)
{
  for (size_t i = 0; i < this->_layer_arrays.size(); i++)
...
template <typename SampleType>
void nam::wavenet::WaveNet<SampleType>::_set_condition_array(SampleType* input, const int num_frames)
{
...
template <typename SampleType>
void nam::wavenet::WaveNet<SampleType>::process(SampleType* input, SampleType* output, const int num_frames)
{
...
template <typename SampleType>
void nam::wavenet::WaveNet<SampleType>::_set_num_frames_(const long num_frames)
{
...
template class nam::wavenet::WaveNet<float>;
template class nam::wavenet::WaveNet<double>;

...
template <typename SampleType>
void namdsp::DSP<SampleType>::_AllocateOutputPointers(const size_t numChannels)
{
...
template <typename SampleType>
void namdsp::DSP<SampleType>::_DeallocateOutputPointers()
{
  if (this->mOutputPointers != nullptr)
  {
...
template <typename SampleType>
SampleType** namdsp::DSP<SampleType>::_GetPointers()
{
...
template <typename SampleType>
void namdsp::DSP<SampleType>::_PrepareBuffers(const size_t numChannels, const size_t numFrames)
{
...
template <typename SampleType>
void namdsp::DSP<SampleType>::_ResizePointers(const size_t numChannels)
{
...
template <typename SampleType>
namdsp::History<SampleType>::History()
: DSP<SampleType>()
, mHistoryRequired(0)
, mHistoryIndex(0)
{
...
template <typename SampleType>
void namdsp::History<SampleType>::_AdvanceHistoryIndex(const size_t bufferSize)
{
  this->mHistoryIndex += bufferSize;
}

template <typename SampleType>
void namdsp::History<SampleType>::_EnsureHistorySize(const size_t bufferSize)
{
...
template <typename SampleType>
void namdsp::History<SampleType>::_RewindHistory()
{
...
template <typename SampleType>
void namdsp::History<SampleType>::_UpdateHistory(SampleType** inputs, const size_t numChannels, const size_t numFrames)
{
...
template class namdsp::DSP<float>;
template class namdsp::DSP<double>;
template class namdsp::History<float>;
template class namdsp::History<double>;